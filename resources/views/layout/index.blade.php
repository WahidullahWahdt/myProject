	...
	<section id="banner" data-video="images/banner">
		<div class="inner">
			...
			<p>A full responsive, business-oriented HTML5/CSS3 template<br>
				built by <a href="assets/https://templated.co">Templated</a> and released under the
                         <a href="https://templated.co/license">Creative Commons</a>.</p>
	...
	<section id="one" class="wrapper style2">
		<div class="inner">
			<div>
				<div class="box">
					<div class="image fit">
						<img src="{{asset('assets/images/pic01.jpg')}}" alt="" width="3472" height="1035">
					</div>
					<div class="content">
		...
		<div class="inner">
			<div class="grid-style">
				...
				<div>
					<div class="box">
						<div class="image fit">
							<img src="{{asset('assets/images/pic02.jpg')}}" alt="" width="3472" height="1236">
						</div>
						<div class="content">
							<header class="align-center">
								<h2>Lorem ipsum dolor</h2>
				...
				<div>
					<div class="box">
						<div class="image fit">
							<img src="{{asset('assets/images/pic03.jpg')}}" alt="" width="3472" height="1236">
						</div>
						<div class="content">
							<header class="align-center">
