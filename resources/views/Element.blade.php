                ...
                <div class="row 200%">
                    ...
                    <div class="6u$ 12u$(medium)">
                        ...
                        <form method="post" action="/mydata">
                            ...
                            <input type="text" name="price" id="" value="" placeholder="Price">
                            </div>
                        ...
                        <div class="6u$ 12u$(xsmall)">
                    <input type="email" name="email" id="" value="" placeholder="Email" style="height: 40px; width: 240px !important; float: left !important;">
                        </div>
                                <!-- Break -->
                                <div class="12u$">
                                    
                                <input type="text" name="category" id="" value="" placeholder="Category"></div>
                                </div>
                                <!-- Break -->
                                ...
                                <!-- Break -->
                                <div class="12u$">
                                    <textarea name="massage" id="demo-message" placeholder="Enter your message" rows="6" data-gramm="false" wt-ignore-input="true" type="text"></textarea></div>
                                <!-- Break -->
                                <div class="12u$">
                        ...
                        <h4>Fit</h4>
                        <span class="image fit"><img src="{{asset('assets/images/pic01.jpg')}}" alt="" width="3472" height="1035"></span>
                        <div class="box alt">
                            <div class="row 50% uniform">
                                <div class="4u"><span class="image fit"><img src="{{asset('assets/images/pic01.jpg')}}" alt="" width="3472" height="1035"></span></div>
                                <div class="4u"><span class="image fit"><img src="{{asset('assets/images/pic01.jpg')}}" alt="" width="3472" height="1035"></span></div>
                                <div class="4u$"><span class="image fit"><img src="{{asset('assets/images/pic01.jpg')}}" alt="" width="3472" height="1035"></span></div>
                                <!-- Break -->
                                <div class="4u"><span class="image fit"><img src="{{asset('assets/images/pic01.jpg')}}" alt="" width="3472" height="1035"></span></div>
